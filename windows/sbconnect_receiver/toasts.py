...
Simple one-way notifications only — media buttons and message replies are
handled by the interactive panel in :mod:`panel`.
"""
...
class ToastService:
    ...
    def _show(title: str, text: str) -> None:
        ...
        Notification(app_id="SBConnect", title=title, msg=text, duration="short").show()
